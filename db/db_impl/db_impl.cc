...
Status DBImpl::CloseImpl() {
  // Add Print to cerr at Close
  /* PerfContext* perf_ctx = get_perf_context(); */
  /* std::cerr << __PRETTY_FUNCTION__ << std::endl; */
  /* if (perf_ctx->level_to_perf_context->size() == 0) */
  /*   std::cerr << "xxxxxxxxxxxxxxxxxxxxxxxx0" << std::endl; */
  /* for (auto [level, per] : *perf_ctx->level_to_perf_context) { */
  /*   std::cerr << "Level is " << level */
  /*             << "  user_key_return_count : " << per.user_key_return_count */
  /*             << std::endl; */
  /* } */
  //
